...
--
-- Hôte : db
-- Généré le : ven. 24 jan. 2025 à 14:12
...
(1, 'Gare Saint-Lazare', 'Terminus'),
(2, 'Gare de Lyon', 'Intermediaire'),
(3, 'Gare Montparnasse', 'Intermediaire'),
(4, 'Gare du Nord', 'Intermediaire'),
(5, 'Gare de Marseille', 'Intermediaire'),
(6, 'Gare de Lyon Part-Dieu', 'Terminus'),
(7, 'Paris Gare de Lyon', 'Intermediaire'),
(8, 'Paris Gare de Lyon', 'Intermediaire'),
(29, 'teestt', 'Terminus');
